...
//        => optionsBuilder.UseSqlServer("Server=SUPERCOMPUTER\\SUPERCOMPUTER;Database=DevXuongMoc;uid=sa;pwd=123456;MultipleActiveResultSets=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AdminLog>(entity =>
        {
            entity.HasKey(e => e.LogId).HasName("PK__ADMIN_LO__4364C882FC3D7FFF");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PARTNER__3214EC27618A2CAE");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SLIDES__3214EC2767FBD69B");
